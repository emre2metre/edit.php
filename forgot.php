...
<head>
	...
	<link rel="stylesheet" href="css/forgot.css?cache=<?=time()?>">
...
<?php
	ukas_giris("ayar.php", "testprofil.php", "<div class='uyarı glassmorphism' id='box'><p>Lütfen boş bırakmayınız!</p></div>", "<div class='uyarı glassmorphism' id='box'><p>Kullanıcı adı veya şifre hatalı!</p></div>");
	...
	<div class="container">
		...
		<div class="login-content">
			<form action="" method="POST">
				<h2 class="title">Kurtarma Sorusu</h2>
           		<div class="input-div one">
           		   ...
           		   <div class="div">
           		   		<h5>Kullanıcı Adı</h5>
           		   		<input type="text" name="kadi" class="input">
           		   </div>
           		</div>
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<h5>Cevap</h5>
           		    	<input type="password" name="cevap" class="input">
            	   </div>
            	</div>
            	<input type="submit" class="btn" name="sifreal" value="Şifre Al" onclick="active()" >
            </form>
        </div>
    </div>
    <script>
